...
def get_params():
    params = {
        'weight': r'E:\RTDETR\RTDETR-20240302\RTDETR-main\runs\train\TSD-DETR(ours)\weights\best.pt',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'E:\RTDETR\RTDETR-20240302\RTDETR-main\dataset\46353.jpg', 'result3')